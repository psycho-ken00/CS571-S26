...
### 0. Featured Item
To get started, let's make sure that you have a working Badger ID! When you open `index.html`, you might see a message that says "Please enter your Badger ID to continue...". **Please enter your Badger ID in the prompt window, press OK, then refresh the webpage.**
...
![A figure showing the expected results for this step.](_figures/step0.png)
...
Not sure what your Badger ID is? Search your email for `CS571 S26 New Badger ID` sent by `ctnelson2@wisc.edu`.
...
The `about-us.html` page is currently empty. Make a *plausible-looking* About Us page using text generated from [lorem ipsum](https://www.lipsum.com/) (be sure to cite your source with a comment!). On this page, you should use multiple heading levels, **bold** and *italic* text (remember to use the appropriate tags!), and insert the image from `assets/bagel.png`. The image must be accessible, so be sure to include an `alt` tag describing what it is! There are no other strict requirements for this section, see the screenshot below for an example.

![A figure showing the expected results for this step.](_figures/step1.png)
...
![A figure showing the expected results for this step.](_figures/step2.png)
...
![A figure showing the expected results for this step.](_figures/step3.png)
...
![A figure showing the expected results for this step.](_figures/step4.png)
...
![A figure showing the expected results for this step.](_figures/step5.png)
...
![A figure showing the expected results for this step.](_figures/step6.png)
...
![A figure showing the expected results for this step.](_figures/step7.png)
...
![A figure showing the expected results for this step.](_figures/step8.png)
...
Finally, add, commit, and push your changed files to your GitHub Classroom repository. Then, zip the `hw1` folder and submit to Gradescope. Autograding tests should complete within a few minutes. Review your results, and submit as many times as you need up until the assignment deadline. 🥳

**Important:** Gradescope expects everything to be within the `hw1` zip. If the file path is not prefixed with `hw1` as below, you will *not* pass the autograder. Other files such as figures and git files can be included, but are ignored by the autograding process.

![A figure showing files are uploaded within a hw1 folder.](_figures/gradescope.png)
