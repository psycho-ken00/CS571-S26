# CS571 S26 HW6 API Documentation
...
`GET` `https://cs571api.cs.wisc.edu/rest/s26/hw6/chatrooms`
...
`GET` `https://cs571api.cs.wisc.edu/rest/s26/hw6/messages?chatroom=CHATROOM_NAME&page=PAGE_NUM`
...
### Registering a User
`POST` `https://cs571api.cs.wisc.edu/rest/s26/hw6/register`
...
`POST` `https://cs571api.cs.wisc.edu/rest/s26/hw6/login`
...
`POST` `https://cs571api.cs.wisc.edu/rest/s26/hw6/messages?chatroom=CHATROOM_NAME`
...
### Deleting a Message
`DELETE` `https://cs571api.cs.wisc.edu/rest/s26/hw6/messages?id=MESSAGE_ID`
...
### Logging out
`POST` `https://cs571api.cs.wisc.edu/rest/s26/hw6/logout`
...
### Who Am I?
`GET` `https://cs571api.cs.wisc.edu/rest/s26/hw6/whoami`
